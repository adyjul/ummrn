    ...
    <nav class="navbar navbar-expand-md navbar-dark navbar-custom fixed-top" style=<?php echo"$navigate";?>>
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="master_riset.php">HOME <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="master_riset.php?page=myriset">MY RISET</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="master_riset.php?page=callForProjectRiset">Call For Projects</a>
                </li>
